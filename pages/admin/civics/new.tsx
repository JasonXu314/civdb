...
import { createCivic } from '../../../utils/http';
...
const New: NextPage = () => {
	...
	return (
		<>
			<Head>
				<title>CivDB | Admin Panel - New Civic</title>
			</Head>
			<CivicsForm
				onSubmit={(data) => {
					const id = randomId();
					notifications.show({ title: 'Submitting...', message: 'Creating civic...', id, autoClose: 5000, loading: true });
					createCivic(data)
						.then((res) => {
...
export default withAuth(New, 'Admin Panel - New Civic');
